    ...
    <nav class="navbar navbar-expand-lg navbg">
          ...
          <div class="container">
              <div class="col-12 aboutusheader">
                <p class="aboutusheaderwelcome">Developed By</p>
              </div>

            <div class="row mb-5 amneibg">
            <?php

                $query = "SELECT * From developerpage";
                $result = mysqli_query($con,$query);

                while($row = mysqli_fetch_array($result)){
                  $text1 = $row['name'];
                  $text2 = $row['title'];
                  $text3 = $row['description'];
                  $text4 = $row['fblink'];
                  $text5 = $row['instalink'];
                  $pic = $row['pic'];
              ...
              ?>
              <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 developingby">
                <div class="userprofileimage">
                    <img src="<?=$pic?>" class=""/>
                </div>
                <p class="developingbyname mt-3"><?=$text1?></p>
                <div class="developingbytexts">
                  <p><?=$text2?></p>
                  <p><?=$text3?></p>
                  <diV class="developingbyicons">
                    <a href="<?php echo $text4?>">
                    <i class=" fab fa-facebook"></i>
                    </a>
                    <a href="<?php echo $text5?>">
                    <i class=" fab fa-instagram-square developingbyinsta"></i>
                    </a>
                  </diV>
                </div>
              </div>
